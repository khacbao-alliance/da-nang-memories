      ...
      {isOpen && media && (
        ...
        >
          ...
          >
            ...
            {/* Caption + meta — no transform, renders crisp */}
            <motion.div
              ...
              exit={{ opacity: 0 }}
              transition={{ duration: 0.2 }}
              className="mt-4 sm:mt-5 text-center max-w-lg px-4 py-3 bg-black/60 backdrop-blur-sm rounded-2xl border border-white/10"
            >
              {media.caption && (
                <p className="text-white text-sm sm:text-base font-semibold mb-2 drop-shadow">{media.caption}</p>
              )}
